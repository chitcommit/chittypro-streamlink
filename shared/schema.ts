...
export const cameras = pgTable("cameras", {
  ...
  position: jsonb("position").$type<{ x: number; y: number; width: number; height: number }>(),
...
export const userLayouts = pgTable("user_layouts", {
  ...
  cameraPositions: jsonb("camera_positions").$type<Record<string, { x: number; y: number; width: number; height: number }>>(),
